...
const path = 'C:/Users/USER/.gemini/antigravity/brain/a605d77e-c5ad-42a6-b52d-9d4753fcd17b/.system_generated/logs/transcript_full.jsonl';
...
rl.on('close', () => {
  ...
  if (f10_start !== -1 && f12_start !== -1) {
    fs.writeFileSync('C:/Users/USER/Documents/GitHub/PROSPECTOR-ATLAS/FASE-10.ps1', foundContent.substring(f10_start, f12_start).trim());
    console.log('FASE-10 written');
  }
  if (f12_start !== -1 && f11_start !== -1) {
    fs.writeFileSync('C:/Users/USER/Documents/GitHub/PROSPECTOR-ATLAS/FASE-12.ps1', foundContent.substring(f12_start, f11_start).trim());
    console.log('FASE-12 written');
  }
  if (f11_start !== -1 && f11_start !== f10_start) {
    fs.writeFileSync('C:/Users/USER/Documents/GitHub/PROSPECTOR-ATLAS/FASE-11.ps1', foundContent.substring(f11_start).trim());
