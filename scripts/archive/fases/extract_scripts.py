...
transcript_path = r"C:\Users\USER\.gemini\antigravity\brain\614eae9f-6d6b-4451-8137-161d310a4c70\.system_generated\logs\transcript_full.jsonl"
                ...
                if '#Requires -Version 5.1' in obj:
                    ...
                    for part in parts[1:]:
                        ...
                        if 'Write-FileFromContent -RelativePath "src/modules/crm/application/' in script:
                            with open(r"C:\Users\USER\Documents\GitHub\PROSPECTOR-ATLAS\FASE-10-APPLICATION.ps1", "w", encoding="utf-8") as out:
                                out.write(script)
                            found_10 = True
                            print("Found FASE 10")
                            
                        if 'FASE 11 — INFRASTRUCTURE LAYER ENTERPRISE' in script:
                            with open(r"C:\Users\USER\Documents\GitHub\PROSPECTOR-ATLAS\FASE-11-INFRASTRUCTURE.ps1", "w", encoding="utf-8") as out:
                                out.write(script)
                            found_11 = True
                            print("Found FASE 11")
