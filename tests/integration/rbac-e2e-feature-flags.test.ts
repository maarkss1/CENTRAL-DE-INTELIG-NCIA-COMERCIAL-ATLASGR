...
import { featureFlagsRouter } from '../../src/features/feature-flags/routes/featureFlags.routes';
import { container } from '../../src/shared/di/container';
import { setupDI } from '../../src/shared/di/setup';
import type { FeatureFlagsUseCases } from '../../src/features/feature-flags/application/FeatureFlagsUseCases';
...
describe('RBAC ponta-a-ponta — Feature Flags', () => {
  ...
  beforeAll(async () => {
    ...
    await withRlsBypass(() =>
      container.resolve<FeatureFlagsUseCases>('FeatureFlagsUseCases').syncRegistry(),
    );
