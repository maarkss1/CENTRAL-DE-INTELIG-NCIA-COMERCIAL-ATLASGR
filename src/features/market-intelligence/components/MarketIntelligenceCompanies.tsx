  ...
  return (
    <div className="space-y-5 p-4 md:p-6 lg:p-8">
      ...
      <form onSubmit={submit} className="rounded-3xl border border-line bg-surface p-4 shadow-sm md:p-5">
        ...
        <div className="mt-4 flex flex-wrap gap-2"><button type="submit" className="inline-flex items-center gap-2 rounded-xl bg-brand-active px-4 py-2.5 text-sm font-black text-white hover:bg-brand-2-active"><Search className="h-4 w-4" /> Consultar</button><button type="button" onClick={clear} className="rounded-xl border border-line px-4 py-2.5 text-sm font-bold text-ink-2 hover:bg-surface-2">Limpar filtros</button></div>
      </form>
