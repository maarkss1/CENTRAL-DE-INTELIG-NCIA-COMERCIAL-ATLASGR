...
import type { CommercialIntelligenceFilter, CommercialIntelligenceRepository, ExecutiveAlert } from '../../domain/CommercialIntelligence';
...
export async function buildAlerts(
    ...
    const previousPerformance = overview.previousPeriod
        ? await buildPerformance(repository, organizationId, { ...filter, month: overview.previousPeriod.period }, now)
        : null;
