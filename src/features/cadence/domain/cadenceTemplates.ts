...
export const CADENCE_JOURNEY_TEMPLATES: CadenceJourneyTemplate[] = [
    {
        ...
        description: 'Cadência focada em transportadoras e frotas de carga pesada, explorando economia real de diesel (8-12%), auditoria de freadas/RPM e telemetria CAN.',
        touches: [
            {
                order: 1,
                channel: 'whatsapp',
                ...
                templateRef: 'Olá {{contact_name}}! Notei que você gerencia a operação na {{company_name}}. Desenvolvemos uma auditoria de telemetria CAN na AtlasGR que reduz em média 9.4% o consumo de diesel e sinistros em frotas pesadas. Gostaria de ver o benchmark do seu segmento?',
            },
            {
                order: 2,
                channel: 'email',
            ...
            },
            {
                ...
                templateRef: 'Ligação do SDR da AtlasGR apresentando diagnósticos de risco e convidando o decisor para uma demonstração com o especialista de engenharia de telemetria.',
            },
            {
                order: 4,
                channel: 'whatsapp',
                ...
                templateRef: '{{contact_name}}, gravei um vídeo de 1 minuto mostrando como o painel de inteligência da AtlasGR avisa o gestor no momento exato de uma infração de telemetria. Consegue dar uma olhada rápida hoje?',
            },
            {
                order: 5,
                channel: 'email',
    ...
    },
    {
        ...
        description: 'Sequência de ultra-velocidade para converter leads que solicitaram cotação no site em menos de 5 minutos, garantindo alta taxa de conversão.',
        touches: [
            {
                order: 1,
                channel: 'whatsapp',
                ...
                templateRef: 'Olá {{contact_name}}! Recebemos sua solicitação de cotação de rastreamento veicular e antifurto na TotalTrac. Para qual tipo de veículo e cidade você precisa de cobertura imediata?',
            },
            {
                order: 2,
                channel: 'voice',
                ...
                templateRef: 'Ligação automática de atendimento para dimensionar a quantidade de rastreadores, botão de pânico e central 24h com pronta resposta.',
            },
            {
                order: 3,
                channel: 'email',
            ...
            },
            {
                ...
                templateRef: 'Oi {{contact_name}}, conseguimos uma condição especial de instalação gratuita para os veículos da {{company_name}} se fecharmos a ativação esta semana. O que acha de finalizarmos o cadastro?',
            },
        ],
    },
    {
        ...
        description: 'Fluxo empático e automatizado para recuperar leads que faltaram à call agendada sem parecer invasivo.',
        touches: [
            {
                order: 1,
                channel: 'whatsapp',
                ...
                templateRef: 'Olá {{contact_name}}! Imaginei que imprevistos operacionais urgentes tenham surgido no horário da nossa reunião hoje. Sem problemas! Quer reagendar para amanhã ou prefere que eu ligue no final da tarde?',
            },
            {
                order: 2,
                channel: 'email',
            ...
            },
            {
                ...
                templateRef: 'Ligação curta e educada para checar se o projeto de monitoramento de frotas continua sendo prioridade para este trimestre.',
            },
        ],
    },
    {
        ...
        description: 'Cadência focada em encurtar o ciclo de vendas após o envio da proposta, eliminando objeções com o comitê financeiro.',
        touches: [
            {
                order: 1,
                channel: 'whatsapp',
                ...
                templateRef: 'Olá {{contact_name}}, conseguiu avaliar a proposta comercial que enviamos ontem? Gostaria de esclarecer algum ponto sobre o cronograma de instalação ou modelo de comodato?',
            },
            {
                order: 2,
                channel: 'email',
            ...
            },
            {
                ...
                templateRef: 'Ligação do Closer para alinhamento dos dados cadastrais, minuta contratual e agendamento dos técnicos de campo.',
            },
        ],
    },
    {
        ...
        description: 'Sequência educativa de longo prazo enviando dicas de gestão de frotas, legislação e telemetria avançada.',
        touches: [
            {
                order: 1,
                channel: 'email',
            ...
            },
            {
                ...
                templateRef: 'Olá {{contact_name}}! Sabia que 60% do desgaste prematuro de pneus e freios ocorre por excesso de velocidade em curvas? Nossos sensores de telemetria alertam a cabine na hora. Quer saber mais?',
            },
            {
                order: 3,
                channel: 'email',
