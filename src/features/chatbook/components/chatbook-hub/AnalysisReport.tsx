...
import { AlertTriangle, CheckCircle2, Phone, RotateCcw, Trophy } from 'lucide-react';
import type { AnalysisResult } from './types';

export function AnalysisReport({
    analysisResult, onRestartText, onRestartVoice,
}: {
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="bg-surface/90 backdrop-blur-2xl rounded-[3rem] p-10 border border-line shadow-[0_30px_60px_rgba(0,0,0,0.08)] space-y-10 relative overflow-hidden">
            ...
            <div className="flex justify-center pt-4 gap-4">
                ...
                <button
                    ...
                    className="px-10 py-5 bg-surface hover:bg-surface-2 border border-line text-ink rounded-[1.75rem] font-black text-sm uppercase tracking-wider flex items-center gap-3 transition-transform hover:scale-105 shadow-xl"
                >
