      ...
      <CardContent className="space-y-4">
        <div className="grid grid-cols-2 gap-3 text-sm">
          ...
          <div>
            ...
            {lead.phone ? (
              <a href={`tel:${lead.phone}`} className="text-brand-active dark:text-brand-2 hover:underline">
                {lead.phone}
              </a>
            ) : (
          ...
          <div>
            ...
            {lead.email ? (
              <a href={`mailto:${lead.email}`} className="text-brand-active dark:text-brand-2 hover:underline">
                {lead.email}
              </a>
            ) : (
              <span className="text-ink">Não informado</span>
