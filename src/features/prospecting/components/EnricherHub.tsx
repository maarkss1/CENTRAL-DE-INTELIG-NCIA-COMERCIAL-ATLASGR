    ...
    return (
        <div className="flex-1 overflow-y-auto bg-gray-50/50 p-6 sm:p-8">
            <div className="max-w-6xl mx-auto space-y-6">
                <div>
                    <h1 className="text-2xl font-black text-atlas-dark">🧪 Enriquecedor de Leads</h1>
                    <p className="text-gray-500 mt-1">Busque uma empresa já cadastrada e rode o enriquecimento completo: Receita Federal + Google Negócios + Apollo.</p>
                </div>
                    ...
                    <div className="xl:col-span-4 bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
                        ...
                        <div className="relative mb-4">
                            ...
                            <input
                                ...
                                className="w-full pl-9 pr-4 py-2.5 bg-gray-50/50 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-atlas-orange/20 focus:border-atlas-orange transition-all outline-none"
                            />
                        </div>
                        ...
                        <div className="space-y-2 max-h-[500px] overflow-y-auto">
                            {results.map((company) => (
                                <button
                                    ...
                                    className={`w-full text-left p-3 rounded-xl border transition-all flex items-center gap-3 ${selected?.id === company.id ? 'border-atlas-orange bg-orange-50/50' : 'border-gray-100 hover:border-atlas-orange/40'}`}
                                >
