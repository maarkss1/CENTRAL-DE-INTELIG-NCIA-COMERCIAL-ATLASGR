            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="p-5 bg-soft/40 rounded-2xl border border-line space-y-4">
                ...
                <a
                  ...
                  target="_blank"
                  download
                  className="w-full py-2.5 px-4 bg-brand-active text-white rounded-xl text-xs font-semibold flex items-center justify-center gap-2 hover:bg-brand-hover transition-colors shadow-sm" rel="noopener"
                >
