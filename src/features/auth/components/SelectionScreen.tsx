    ...
    <div className="min-h-screen bg-[#030305] text-white flex flex-col items-center justify-center relative overflow-hidden font-sans p-6">
      ...
      <div className="w-full max-w-5xl relative z-10 flex flex-col items-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl">
          ...
          >
            ...
            <div className="relative h-full glass-panel p-10 rounded-[2.5rem] border border-white/10 bg-slate-900/60 backdrop-blur-xl flex flex-col items-center text-center overflow-hidden transition-all duration-500 group-hover:border-atlas-orange/50 group-hover:bg-slate-900/80">
              ...
              <div className="w-48 h-24 mb-6 flex items-center justify-center transform group-hover:scale-110 group-hover:rotate-6 transition-all duration-500">
                <Logo variant="white" className="w-full h-full drop-shadow-2xl" />
              </div>
          ...
          >
            ...
            <div className="relative h-full glass-panel p-10 rounded-[2.5rem] border border-white/10 bg-slate-900/60 backdrop-blur-xl flex flex-col items-center text-center overflow-hidden transition-all duration-500 group-hover:border-totaltrack-blue/50 group-hover:bg-slate-900/80">
              
              <div className="w-48 h-24 mb-6 flex items-center justify-center transform group-hover:scale-110 group-hover:-rotate-6 transition-all duration-500">
                <TotalTrackLogo tone="negative" className="w-full h-full drop-shadow-2xl" />
              </div>
              ...
              <div className="mt-auto px-6 py-3 rounded-full bg-white/5 border border-white/10 text-sm font-semibold text-white group-hover:bg-totaltrack-blue group-hover:border-totaltrack-blue transition-all duration-300">
                Acessar Total Trac
              </div>
            </div>
          </motion.div>
      ...
      <div className="relative w-full text-center z-20 pointer-events-none flex justify-center mt-12 pb-6">
        <motion.div 
          ...
          className="px-6 py-3 rounded-2xl bg-gradient-to-r from-atlas-orange/20 to-totaltrack-blue/20 border border-white/30 backdrop-blur-xl"
        >
