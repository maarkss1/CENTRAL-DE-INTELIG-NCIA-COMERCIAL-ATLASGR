...
export function GlowChart({ data, error }: GlowChartProps) {
  ...
  return (
    <section
      ...
      className="group relative min-h-[22rem] w-full overflow-hidden rounded-[1.6rem] border border-line bg-surface/92 p-5 shadow-[0_28px_70px_-42px_rgba(0,0,0,0.85),inset_0_1px_0_rgba(255,255,255,0.06)] sm:p-6"
    >
      <motion.div
        aria-hidden="true"
