...
import { qualificationMatrixItemSchema, type QualificationMatrixItemInput } from '../../playbook.schema';
import { BaseUseCases } from '../../../../shared/application/BaseUseCases';

export class QualificationMatrixUseCases extends BaseUseCases<QualificationMatrixItem, QualificationMatrixItemRepository> {
    ...
    async updateItem(organizationId: string, id: string, data: Partial<QualificationMatrixItemInput>) {
